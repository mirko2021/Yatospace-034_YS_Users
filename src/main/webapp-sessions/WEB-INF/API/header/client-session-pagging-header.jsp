...
<c:if test='${param["report_page_previous_us"] ne null}'>
	<c:out value="${reportPaggingBeanCUS.setPageSize(param['pageSize'])}"></c:out>
	<c:out value="${reportPaggingBeanCUS.previous(param['pageNo'])}"></c:out>
</c:if>

<c:if test='${param["report_page_refresh_us"] ne null}'>
	<c:out value="${reportPaggingBeanCUS.setPageSize(param['pageSize'])}"></c:out>
	<c:out value="${reportPaggingBeanCUS.refresh(param['pageNo'])}"></c:out>
</c:if>

<c:if test='${param["report_page_next_us"] ne null}'>
	<c:out value="${reportPaggingBeanCUS.setPageSize(param['pageSize'])}"></c:out>
	<c:out value="${reportPaggingBeanCUS.next(param['pageNo'])}"></c:out>
</c:if>
