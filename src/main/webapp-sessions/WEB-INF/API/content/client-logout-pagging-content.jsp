	...
	<form id='report_page_form_us' name='report_page_form_us' method='POST'>
		<table>
			<tr>
				...
				<td><input type='number' value='${reportPaggingBeanCLUS.pageSize}' min='1' name='pageSize'/></td>
			</tr>
			<tr>
				<td>Број странице: </td>
				<td><input type='number' value='${reportPaggingBeanCLUS.pageNo}' min='0' name='pageNo'/></td>
			</tr>
		</table>
		<br>
